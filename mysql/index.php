...
<td><a href="update.php?id=<?php echo $row["id"]; ?>" title='Update Record'><i class="fa fa-pencil"></i></a>

<a href="delete.php?id=<?php echo $row["id"]; ?>" title='Delete Record'><i class="fa fa-trash-o"></i></span></a>
